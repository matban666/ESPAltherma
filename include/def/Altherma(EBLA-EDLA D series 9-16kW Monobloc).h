...
//{0x21,6,105,2,1,"Fan1 Fin temp."}, //0
//{0x21,8,105,2,1,"Fan2 Fin temp."}, //0
//{0x21,10,105,2,1,"Compressor outlet temperature"}, //0
//{0x00,0,995,1,-1,"NextDataGrid"},
{0x30,0,152,1,-1,"INV frequency (rps)"},
{0x30,1,211,1,-1,"Fan 1 (step)"},
//{0x30,2,211,1,-1,"Fan 2 (step)"}, //0
...
//{0x63,13,311,1,-1,"BUH output capacity"}, //"Conv 311 not avail."
